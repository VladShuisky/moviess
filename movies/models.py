...
class Actor(models.Model):
    ...
    # age = models.BigIntegerField("Возраст")
    description = models.TextField("Описание")
    image = models.ImageField("Изображение", upload_to="actors/")
    date_of_birth = models.DateField("Дата рождения", auto_now_add=False, blank=False)
...
class Movie(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("movies:moviedetail", kwargs={"slug": self.url})
